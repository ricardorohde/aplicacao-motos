...
<html>
    <head>
        <title>Cadastrar Apoio a Eventos</title>
        <meta charset="UTF-8">
    ...
    <body style="width: ; background: orange; margin: 0 auto;">
        ...
        <h2 style="text-align: center;color: white; "><u>Apoio a Eventos:</u></h2>
        <hr>
        <form action="cad_evento.php" method="post" >
            
            <div class="row">
                <div class="form-group col-md-4 col-sm-12 col-sm-12">
            ...
            <div class="form-group">
                <label for="obra">Evento:</label>
                <input type="text" class="form-control text-uppercase" id="evento" name="evento" placeholder="Preencher Evento" required>
            </div>
